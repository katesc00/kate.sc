...
namespace Proyecto_final
{
    class Class4
    {
        public static void Especialidades()
        {
            ...
            Console.WriteLine("1. Biomecánica ");
            Console.WriteLine("2. Ingeniería Clínica");
            ...
            switch (n)
            {
                ...
                case 3:
                    Console.Clear();
                    Console.WriteLine("Ingeniería para rehabilitación \n");
                ...
                case 5:
                    Console.Clear();
                    Console.WriteLine("Investigación de biomateriales \n");
